...
from tb4_autonomy_real.detectors.static_ball_detector import StaticBallDetectorConfig, StaticObstacleDetector
from tb4_autonomy_real.utils.image_tools import draw_detections
