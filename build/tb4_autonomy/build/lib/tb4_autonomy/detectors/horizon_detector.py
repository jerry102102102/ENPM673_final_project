...
class HorizonDetector:
    ...
    def _fit_line_ransac(self, points, n_trials=100, threshold=5):
        if len(points) < 2:
            return None, 0.0
    ...
    def detect(self, frame, context) -> HorizonDetection | None:
        ...
        # only keep pixels where vertical gradient dominates (horizontal edge)
        ...
        result, inlier_ratio = self._fit_line_ransac(points, n_trials=200, threshold=15)
